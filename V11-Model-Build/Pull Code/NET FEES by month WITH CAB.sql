...
select * from generate_series(1,24,1) as g(x);
$$ Language sql rows 24
;
...
-- create temp table first_funded loans as
...
--THIS CONTROLS HOW OLD YOUR CUSTOMERS ARE
    and l.funding_date_actual >= current_date - interval'30 months'
...
-- limit 1000
-- order by month_calculated -- Useful for testing, otherwise your months get all out of order but slow for full build
)
-- ;
